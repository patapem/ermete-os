...
- Worker successfully updated the SKILL files with explicit anti-overwrite clauses for `forge/` and `ermete-shell-rs/` and explicit cross-agent delegation instructions.
