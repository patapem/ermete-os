...
- Reference: `ermete-forge/specs/ermete-kernel/prepare-chimera.sh` for patch routing
- Reference: `ermete-forge/specs/ermete-kernel/README.md` for kernel architecture
