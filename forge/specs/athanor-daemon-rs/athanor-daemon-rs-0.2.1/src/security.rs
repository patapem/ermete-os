...
/// Applies capability dropping for athanor-daemon-rs
/// Retains: CAP_NET_ADMIN (12), CAP_SYS_NICE (23)
pub fn apply_daemon_hardening() {
    match drop_capabilities(&[12, 23]) {
        Ok(_) => info!("🔒 Capability Dropping applied successfully for athanor-daemon-rs (Retained: CAP_NET_ADMIN, CAP_SYS_NICE)."),
