...
**Goal:** Rewrite `athanor-settings-rs` to a Relm4 component architecture using a global CSS design system, and implement DBus live theming sync.

**Architecture:** Convert `athanor-settings-rs` to use Relm4 with an `AppModel` and a modular page component system. A central CSS file will provide the glassmorphism and premium tokens.
...
- Code must reside in `specs/athanor-settings-rs/athanor-settings-rs-1.0.0/`.
...
**Files:**
- Modify: `specs/athanor-settings-rs/athanor-settings-rs-1.0.0/Cargo.toml`
- Create: `specs/athanor-settings-rs/athanor-settings-rs-1.0.0/src/style.rs`
...
**Files:**
- Modify: `specs/athanor-settings-rs/athanor-settings-rs-1.0.0/src/main.rs`
...
Replace GTK4 manual loop with Relm4 `RelmApp::new("os.athanor.Settings").run::<AppModel>(())`.
