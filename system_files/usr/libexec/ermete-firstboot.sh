...
if flatpak remote-add --if-not-exists flathub https://dl.flathub.org/repo/flathub.flatpakrepo && \
   ...
   flatpak install -y flathub io.github.flattool.Warehouse com.github.tchx84.Flatseal com.obsproject.Studio com.github.wwmm.easyeffects org.mozilla.firefox; then
