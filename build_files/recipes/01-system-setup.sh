...
dnf -y install --setopt=install_weak_deps=False libvirt virt-manager qemu-kvm flatpak-builder wlr-randr sysstat lxqt-openssh-askpass lxpolkit parallel just seahorse firewalld zram-generator zram-generator-defaults
...
dnf -y install --setopt=install_weak_deps=False nautilus alacritty mpv
