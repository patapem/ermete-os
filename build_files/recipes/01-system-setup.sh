...
dnf5 -y install --setopt=install_weak_deps=False libvirt virt-manager qemu-kvm wlr-randr sysstat lxqt-openssh-askpass lxpolkit parallel just seahorse gnome-keyring network-manager-applet blueman playerctl brightnessctl alacritty nix greenboot greenboot-default-health-checks bpftool drm_info nftables wayland-utils
